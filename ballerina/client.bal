...
public isolated client class Client {
    ...
    # + return - OK 
    resource isolated function get batch/jobs(map<string|string[]> headers = {}, *Jobs_api_routes_batch_get_batch_jobsQueries queries) returns BatchJobsOut|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - OK 
    resource isolated function get files(map<string|string[]> headers = {}, *Files_api_routes_list_filesQueries queries) returns ListFilesOut|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - OK 
    resource isolated function get files/[string fileId]/url(map<string|string[]> headers = {}, *Files_api_routes_get_signed_urlQueries queries) returns FileSignedURL|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - OK 
    resource isolated function get fine_tuning/jobs(map<string|string[]> headers = {}, *Jobs_api_routes_fine_tuning_get_fine_tuning_jobsQueries queries) returns JobsOut|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful Response 
    resource isolated function get models/[string modelId](map<string|string[]> headers = {}) returns ResponseRetrieveModelV1ModelsModelIdGet|error {
        string resourcePath = string `/models/${getEncodedUri(modelId)}`;
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - OK 
    resource isolated function post fine_tuning/jobs(JobIn payload, map<string|string[]> headers = {}, *Jobs_api_routes_fine_tuning_create_fine_tuning_jobQueries queries) returns Response|error {
        string resourcePath = string `/fine_tuning/jobs`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        http:Request request = new;
        json jsonBody = payload.toJson();
